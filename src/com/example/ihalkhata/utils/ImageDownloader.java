...
public class ImageDownloader extends AsyncTask<List<NameValuePair>, Integer, Void> {
	...
	public ImageDownloader(String url, ProgressBar pb, Button save,
			ImageView img, TextView percent, Context c, Bitmap bmp,
	...
	protected Void doInBackground(List<NameValuePair>... arg0) {
		...
		bmp = getBitmapFromURL(url,arg0[0]);
	...
	public static Bitmap getBitmapFromURL(String link,List<NameValuePair> nameValuePairs) {
